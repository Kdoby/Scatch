package NotModified304.Scatch.repository.interfaces.calendar;
...
public interface EventRepository extends JpaRepository<Event, Long> {
    ...
    List<Event> findRepeatEvents(@Param("username") String username);
    ...
    @Query("select e from Event e " +
            ...
            "order by case when e.startDate <> e.endDate then 0 else 1 end, e.startDate")
    List<Event> findSingleEventsByDate(@Param("username") String username,
